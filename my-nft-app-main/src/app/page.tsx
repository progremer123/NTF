      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-6 mb-6 text-white">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 mb-4">
            <h2 className="text-xl font-semibold mb-2">학생 정보</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              <div>
                <span className="text-white/80">학번:</span>
                <span className="ml-2 font-mono font-semibold">92113633</span>
              </div>
              <div>
                <span className="text-white/80">이름:</span>
                <span className="ml-2 font-semibold">백이랑</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
            ...
            <div className="space-y-2">
              <div>
                <span className="text-white/80">컨트랙트 주소:</span>
                <div className="flex items-center gap-2 mt-1 flex-wrap">
                  <span className="font-mono text-sm bg-white/20 px-3 py-1 rounded break-all">
                    {contractAddress}
                  </span>
                  <a
              ...
              {contractInfo && (
                <div>
                  <span className="text-white/80">토큰 이름:</span>
                  <span className="ml-2 font-semibold">{contractInfo.name} ({contractInfo.symbol})</span>
                </div>
              )}
              {address && (
                <div>
                  <span className="text-white/80">현재 연결된 소유자 주소:</span>
                  <div className="font-mono text-sm bg-white/20 px-3 py-1 rounded mt-1 break-all">
                    {address}
                  </div>
                </div>
              )}
          ...
          {!address ? (
            <div>
              <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">
                MetaMask 지갑을 연결하여 NFT를 민팅하고 관리하세요
              </p>
              <button
            ...
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-semibold text-green-800 dark:text-green-200">지갑 연결됨</span>
              </div>
              <div className="space-y-2 text-sm">
                <div className="text-zinc-700 dark:text-zinc-300">
                  <span className="font-medium">연결된 주소:</span>
                  <div className="font-mono text-xs bg-white dark:bg-zinc-800 px-2 py-1 rounded mt-1 break-all">
                    {address}
                  </div>
                </div>
                <div className="text-zinc-700 dark:text-zinc-300">
                  <span className="font-medium">보유 NFT 수:</span>
                  <span className="ml-2 font-semibold text-blue-600 dark:text-blue-400">{balance.toString()}</span>
                </div>
              </div>
            </div>
          )}
